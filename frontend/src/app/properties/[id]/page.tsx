...
const PropertyDetailPage = ({ params }: PropertyDetailPageProps) => {
  ...
  // Convert listing to property format for this component
  const property: Property | null = listing ? convertListingToProperty(listing) : null;
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="flex-1">
              <nav className="flex items-center space-x-2 text-emerald-100 text-sm mb-6">
                ...
                <InstantLoadingLink href="/properties" className="hover:text-white transition-colors">
                  Properties
                </InstantLoadingLink>
                <BreadcrumbChevron className="h-4 w-4" />
                    ...
                    <div>
                      ...
                      <div className="space-y-3">                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{property.fireplaces}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">${property.hoa_fee}/month</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Property Taxes:</span>
                          <span className="font-medium">${property.property_taxes?.toLocaleString()}/year</span>
                        </div>
                        <div className="flex justify-between">
                ...
                <div className="flex items-center justify-center mt-2 space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`h-4 w-4 ${
                        i < Math.floor(property.realtor.rating || 0) 
              ...
              {isQuickActionsOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-full left-0 right-0 mb-4 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden z-50"
                  >
