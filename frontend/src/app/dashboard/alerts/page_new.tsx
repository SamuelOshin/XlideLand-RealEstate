...
import { PropertyAlert, Notification } from '@/types/index'
...
export default function AlertsPage() {
  ...
  const filteredAlerts = propertyAlerts
    .filter(alert => {      if (!searchQuery) return true
      const searchLower = searchQuery.toLowerCase()
      return (
        alert.alert_type?.toLowerCase().includes(searchLower) ||
        JSON.stringify(alert.criteria || {}).toLowerCase().includes(searchLower) ||
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="font-medium text-gray-900">{alert.alert_type || alert.name}</h3>
                            <Badge 
                              variant="secondary" 
                          ...
                          <p className="text-gray-600 mb-2">{JSON.stringify(alert.criteria || {})}</p>
                          <div className="flex items-center text-sm text-gray-500">
                            <Calendar className="w-4 h-4 mr-1" />
