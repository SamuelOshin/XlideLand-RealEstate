...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      date: 'November 2023',
      testimonial: 'Relocating from California with two young children seemed daunting, but Michael Chen made it effortless. He understood our family\'s needs perfectly and showed us properties that matched our lifestyle. The virtual tours were incredibly helpful, and he coordinated everything so smoothly that we closed on our dream home before we even moved to Boston!',
