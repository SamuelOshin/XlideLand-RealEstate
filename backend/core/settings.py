"""
Django settings for XlideLand Backend API.
"""
...
# Database Configuration - Optimized for free tier
DATABASE_URL = os.getenv('DATABASE_URL')

if DATABASE_URL:
    # Production: Use PostgreSQL with connection URL
    import dj_database_url
    DATABASES = {
        'default': dj_database_url.parse(
            DATABASE_URL,
            conn_max_age=300,  # Reduced from 600 for free tier
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'XlideLand Real Estate API',
    'DESCRIPTION': 'API for XlideLand Real Estate Platform',
    'VERSION': '1.0.0',
